import RNBluetoothClassicModule, { StandardOptions } from 'react-native-bluetooth-classic/lib/BluetoothNativeModule';
import BluetoothDevice from 'react-native-bluetooth-classic/lib/BluetoothDevice';
import { BluetoothEventListener, StateChangeEvent, BluetoothDeviceEvent, BluetoothEventSubscription } from 'react-native-bluetooth-classic/lib/BluetoothEvent';
import { BluetoothDeviceReadEvent } from 'react-native-bluetooth-classic/lib/BluetoothEvent';
...
export default class BluetoothModule {
     ...
     */
    accept<T extends StandardOptions>(properties: T): Promise<BluetoothDevice>;
    /**
