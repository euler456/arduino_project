...
import BluetoothNativeDevice from 'react-native-bluetooth-classic/lib/BluetoothNativeDevice';
import { BluetoothEventListener, BluetoothDeviceReadEvent, BluetoothEventSubscription } from 'react-native-bluetooth-classic/lib/BluetoothEvent';
import { StandardOptions } from 'react-native-bluetooth-classic/lib/BluetoothNativeModule';
...
export default class BluetoothDevice implements BluetoothNativeDevice {
     ...
     */
    connect: <T extends StandardOptions>(options?: T | undefined) => Promise<boolean>;
    /**
